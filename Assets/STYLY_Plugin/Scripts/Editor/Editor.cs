...
namespace STYLY.Uploader
{
    ...
    public class Editor
    {
        ...
        static void Startup()
        {
            ...
            string email = EditorPrefs.GetString(SettingsWindow.SETTING_KEY_STYLY_EMAIL);
            string api_key = EditorPrefs.GetString(SettingsWindow.SETTING_KEY_STYLY_API_KEY);
        ...
        {
            var settings = ScriptableObject.CreateInstance<SettingsWindow>();
            settings.Show();
        }
