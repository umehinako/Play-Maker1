...
//			RuntimePlatform.WSAPlayerX86, // UWP用
        ...
        {
            get => EditorPrefs.GetBool(SettingsWindow.SETTING_KEY_STYLY_AZCOPY_ENABLED, GetAzCopyEnabledDefaultValue());
            set => EditorPrefs.SetBool(SettingsWindow.SETTING_KEY_STYLY_AZCOPY_ENABLED, value);
        }
